 ...
 */
@Controller("adminBannerTypeController")
...
public class BannerTypeController {
    ...
    public String index(Model model, HttpServletRequest request,Type type){
        ...
        JSONObject response = WebUtils.doRawRequest(API.BANNER_TYPE_LIST,type);
        ...
        return "admin/banner/bannerType";
    }
    ...
    public String getType(Model model, HttpServletRequest request, Type type){
        return WebUtils.doRawRequest(API.BANNER_TYPE_GET,type).toString();
    }
    ...
    public String saveType(Model model, HttpServletRequest request, Type type){
        return WebUtils.doRawRequest(API.BANNER_TYPE_SAVE,type).toString();
    }
    ...
    public String updateType(Model model, HttpServletRequest request, Type type){
        return WebUtils.doRawRequest(API.BANNER_TYPE_UPDATE,type).toString();
    }
    ...
    public String removeType(Model model, HttpServletRequest request, Type type){
        return WebUtils.doRawRequest(API.BANNER_TYPE_REMOVE,type).toString();
    }

    @RequestMapping(value="/type/combo/tree",method = RequestMethod.POST)
    @ResponseBody
    public String getTreeType(Type type){
        return WebUtils.doRawRequest(API.BANNER_TYPE_COMBO,type).toString();
    }
}

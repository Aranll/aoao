...
<html>
<head>
    <title>澳彩网-系统管理-文章管理-新增文章</title>
                    ...
                    <form class="form-horizontal" name="form">
                        ...
                        <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <input name="seq" type="text" class="form-control" maxlength="20">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                        ...
                        <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <input type="text" readonly onclick="showMenu(this,0)" name="type.name" class="form-control">
                        ...
                        <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                            <div class="row">
                                ...
                                <input id="images" type="hidden" name="image"/>
                            </div>
                        </div>
    ...
    <script>
        ...
        $form.validate({
            ...
            submitHandler: function (form) {
                ...
                doPost("<%=request.getContextPath()%>/admin/article/article/save", $(form).serialize(), function (data) {
                    if (data.status) {
